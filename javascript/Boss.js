    ...
    if (this.currentAnimation === 'walking') {
      ...
      if (this.attack1Animation.currentFrame === this.attack1Animation.totalFrames) {
        ...
        if (this.lookingRight) {
          level.bombs.push(
            new Bomb(this.x - randomDistance, this.y + this.height / 2 + randomX, 6, true, this.bombDamage),
          );
          ...
          level.bombs.push(
            new Bomb(this.x - randomDistance, this.y + this.height / 2 + randomX, -6, false, this.bombDamage),
          );
